...
private let beforeTheUpdateDirectoryName = "BeforeTheUpdate"
private let afterTheUpdateDirectoryName = "AfterTheUpdate"
...
final class FileTests: XCTestCase {
    ...
    func testReadVersionStringsInfoOneLine() {
        ...
        XCTAssertEqual(versionStringsInfos.first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testFindItOneLine.swift")
    ...
    func testReadVersionStringsInfo() {
        ...
        XCTAssertEqual(versionStringsInfos.first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testFindIt.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst().first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testFindIt.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(2).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testFindIt.md")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(3).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testFindItTests.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(4).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/.travis.yml")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(5).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/.travis.yml")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(8).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(9).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(10).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(11).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/Cartfile")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(12).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/Cartfile")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(13).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/Cartfile.private")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(14).first?.filePath, "./\(testDirectoryName)/\(afterTheUpdateDirectoryName)/.swift-version")
