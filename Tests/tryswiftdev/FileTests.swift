...
final class FileTests: XCTestCase {
    ...
    func testReadVersionStringsInfoOneLine() {
        ...
        XCTAssertEqual(versionStringsInfos.first?.filePath, "./\(testDirectoryName)/testFindItOneLine.swift")
    ...
    func testReadVersionStringsInfo() {
        ...
        XCTAssertEqual(versionStringsInfos.first?.filePath, "./\(testDirectoryName)/testFindIt.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst().first?.filePath, "./\(testDirectoryName)/testFindIt.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(2).first?.filePath, "./\(testDirectoryName)/testFindIt.md")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(3).first?.filePath, "./\(testDirectoryName)/testFindItTests.swift")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(4).first?.filePath, "./\(testDirectoryName)/.travis.yml")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(5).first?.filePath, "./\(testDirectoryName)/.travis.yml")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(6).first?.filePath, "./\(testDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(7).first?.filePath, "./\(testDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(8).first?.filePath, "./\(testDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(9).first?.filePath, "./\(testDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(10).first?.filePath, "./\(testDirectoryName)/testTryswiftdev.podspec")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(11).first?.filePath, "./\(testDirectoryName)/Cartfile")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(12).first?.filePath, "./\(testDirectoryName)/Cartfile")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(13).first?.filePath, "./\(testDirectoryName)/Cartfile.private")
        ...
        XCTAssertEqual(versionStringsInfos.dropFirst(14).first?.filePath, "./\(testDirectoryName)/.swift-version")
...
extension VersionTests {
    ...
    func testUpdateVersionStringsOneLine() {
        ...
        targetFiles.forEach {
            let targetFullPath = "\(cd)/\(testDirectoryName)/\($0)"
            let beforeChangeFilePath = "\(cd)/\(testDirectoryName)/beforeChange/\($0)"
            // TODO: How to test
